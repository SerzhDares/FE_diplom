    ...
    <div className="wagon_type_choosing">
        <h3 className="ticket_options_title">Тип вагона</h3>
            ...
            {uniqueTypes.length && uniqueTypes.map((wagon: any) => (
                <div className="train_wagon_types">
                    {wagon.coach.class_type == "fourth" &&   
                        <div className="ticket_wagon-type">
                            <label className="wt_radio">
                                <input type="radio" className="wt_radio_input" value="Сидячий" checked={type=="Сидячий" ? true : false} onChange={activeWagonType}/>
                    ...
                    {wagon.coach.class_type == "third" &&
                        <div className="ticket_wagon-type">
                            <label className="wt_radio">
                                <input type="radio" className="wt_radio_input" value="Плацкарт" checked={type=="Плацкарт" ? true : false} onChange={activeWagonType}/>
                                <div className="wt_content">
                    ...
                    {wagon.coach.class_type == "second" &&
                        <div className="ticket_wagon-type">
                            <label className="wt_radio">
                                <input type="radio" className="wt_radio_input" value="Купе" checked={type=="Купе" ? true : false} onChange={activeWagonType}/>
                                <div className="wt_content">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {wagon.coach.class_type == "first" &&
                        <div className="ticket_wagon-type">
                            <label className="wt_radio">
                                <input type="radio" className="wt_radio_input" value="Люкс" checked={type=="Люкс" ? true : false} onChange={activeWagonType}/>
                                <div className="wt_content">
